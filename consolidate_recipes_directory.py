...
# 1. Ensure apps/web/src/app/recipes/page.tsx exists and is populated
...
import { 
  ...
  Clock, Users, CalendarPlus, UploadCloud, Utensils, Check, Star 
} from 'lucide-react';
...
export default function SavedRecipesPage() {
  ...
  const [formCookTime, setFormCookTime] = useState('10 mins');
...
with open("apps/web/src/app/recipes/page.tsx", "w", encoding="utf-8") as f:
    f.write(saved_recipes_code)

# 2. Redirect /saved to /recipes so there is only 1 unified route
...
print("✅ Consolidated to 1 canonical directory at /recipes with /saved auto-redirecting!")
