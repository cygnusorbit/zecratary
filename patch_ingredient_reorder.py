          ...
          <div className="bg-[#111726] border border-slate-800 rounded-3xl max-w-4xl w-full max-h-[92vh] flex flex-col overflow-hidden shadow-2xl relative">
            ...
            <div className="overflow-y-auto flex-1 space-y-6">
              ...
              {!isEditing ? (
                ...
                /* FULL EDIT FORM WITH MOVE UP/DOWN BUTTONS MATCHING REFERENCE */
                <div className="p-6 space-y-6">
                  ...
                  {/* INGREDIENTS EDIT TAB WITH MOVE UP/DOWN BUTTONS */}
                  {editTab === 'ingredients' && (
                    <div className="space-y-4 text-xs">
                  ...
                  {/* STEPS EDIT TAB WITH MOVE UP/DOWN BUTTONS */}
                  {editTab === 'steps' && (
                    <div className="space-y-4 text-xs">
                      <div className="flex justify-between items-center">
...
print("✅ Upgraded ingredients and steps editor with functional Move Up/Down reorder controls!")
