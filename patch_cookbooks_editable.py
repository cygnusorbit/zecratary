...
# Try to write to app cookbooks route
os.makedirs("apps/web/src/app/cookbooks", exist_ok=True)
with open("apps/web/src/app/cookbooks/page.tsx", "w", encoding="utf-8") as f:
    f.write(code)

print("✅ Cookbook editing feature installed successfully!")
