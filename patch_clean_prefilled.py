...
# -------------------------------------------------------------
# 1. Manual Page (`apps/web/src/app/manual/page.tsx`) - Empty default state
# -------------------------------------------------------------
...
print("✅ Pre-filled fields removed! Both manual creation and edit pages now start completely blank.")
