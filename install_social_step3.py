...
print(f"✓ Provisioned social auth engine: {social_auth_path}")

# 3. Provision /register/page.tsx
...
for d in dest_dirs:
    ...
    print(f"✓ Provisioned Registration Page: {target_path}")

print("Step 3 successfully installed!")
