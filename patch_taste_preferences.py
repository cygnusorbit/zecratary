    ...
    try {
      ...
      setMessages(prev => [...prev, {
        ...
        recipe: {
          ...
          description: `Prepared for ${servings} servings, featuring taste preferences: (${tastes.join(', ') || 'Balanced'}).`,
          servings: servings,
          prepTimeMinutes: 15,
          cookTimeMinutes: 20,
          calories: 420,
          ...
          fatGrams: 12,
          ingredients: [
            { item: "Fresh Ingredients", quantity: "300g" },
            { item: "Custom Seasonings", quantity: "To taste" }
          ],
          instructions: [
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-[#111726] border border-slate-800 rounded-3xl max-w-lg w-full max-h-[90vh] flex flex-col overflow-hidden shadow-2xl relative p-6 space-y-6">
            ...
            <div className="overflow-y-auto flex-1 space-y-5 pr-1 text-xs">
              ...
              {/* Tastes Section (Matching your reference design) */}
              <div className="space-y-2">
...
print("✅ Tastes section successfully added to Recipe Preferences Modal!")
