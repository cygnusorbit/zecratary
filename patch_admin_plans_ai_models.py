...
print("\n🎉 /admin/plans updated: 'Allowed AI Models' now features provider buttons, version dropdowns synced with /admin/ai-settings, and interactive model tag management!")
