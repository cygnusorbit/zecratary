...
export default function ManualRecipePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 text-slate-100 pb-16">
      ...
      {/* Segmented Tabs Matching Reference Screenshot */}
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        {/* TAB 1: BASIC INFO & PHOTO UPLOAD */}
        {activeTab === 'info' && (
          <div className="space-y-6 animate-in fade-in">
            {/* Photo Upload Box matching Reference */}
...
print("✅ Manual page updated with separate tabs and photo upload box!")
