...
# 2. Write lib/socialAuth.ts (Configuration Store)
...
print(f"✓ Created configuration engine at: {social_auth_path}")


# 3. Write admin/social-settings/page.tsx (Admin UI)
admin_settings_dir = os.path.join(app_dir, 'admin', 'social-settings')
os.makedirs(admin_settings_dir, exist_ok=True)
admin_settings_path = os.path.join(admin_settings_dir, 'page.tsx')

admin_settings_code = """'use client';
...
with open(admin_settings_path, 'w', encoding='utf-8') as f:
    f.write(admin_settings_code)
print(f"✓ Installed Step 1: /admin/social-settings page at: {admin_settings_path}")
