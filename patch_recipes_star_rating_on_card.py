...
export default function SavedRecipesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 text-slate-100 pb-16 px-4">
      ...
      {/* Recipe Grid with Star Rating Next to Category Badge */}
      {loading ? (
            ...
            return (
              ...
              >
                ...
                <div className="p-4 space-y-2">
                  ...
                  {/* Card Bottom Row: Category Pill + Star Rating + Cook Time */}
                  <div className="flex items-center justify-between pt-1">
                    <div className="flex items-center gap-2">
                      ...
                      {/* STAR RATING BADGE NEXT TO MAIN DISH */}
                      {(r.rating || 0) > 0 ? (
            ...
            <div className="overflow-y-auto flex-1">
              {!isEditing ? (
                ...
                <div className="space-y-5 pb-6">
                  ...
                  {/* Top Action Row with ADD TO BOOK and ADD TO PLAN */}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        ...
                        <span className={`w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold ${
                          selectedRecipe.isCooked ? 'bg-slate-400 text-black' : 'border border-slate-600'
                        }`}>
...
print("✅ Star rating badge added next to 'Main Dish' on /recipes cards!")
