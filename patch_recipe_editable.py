          ...
          <div className="bg-[#111726] border border-slate-800 rounded-3xl max-w-3xl w-full max-h-[92vh] flex flex-col overflow-hidden shadow-2xl relative">
            ...
            <div className="overflow-y-auto flex-1 space-y-6">
              ...
              {!isEditing ? (
                ...
                /* EDIT RECIPE FORM (Matching Reference Design) */
                <div className="p-6 space-y-6">
                  <div className="flex justify-between items-center border-b border-slate-800 pb-4">
                    <h3 className="text-xl font-bold text-white flex items-center gap-2">
                      <Edit3 className="h-5 w-5 text-[#E05638]" /> Edit Recipe Details
                    </h3>
                    <button
                  ...
                  <div className="space-y-4 text-xs">
                    ...
                    <div className="pt-4 flex justify-end gap-3">
                      ...
                      <button
                        ...
                        className="px-6 py-2.5 rounded-xl bg-[#E05638] text-white font-bold hover:bg-[#c94529] transition flex items-center gap-2 shadow-lg shadow-[#E05638]/20"
                      >
...
print("✅ Recipe editing feature installed successfully!")
