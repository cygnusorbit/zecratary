...
import { 
  ...
  Check, Shield, CheckCircle2, Eye, RefreshCw, Edit3, DollarSign, Copy, Plus, Calendar, Tag, Star, Cpu
} from 'lucide-react';
                    ...
                    >
                      <div className="space-y-1">
                        ...
                        <div className="text-xs space-x-2" style={{ color: isDayMode ? '#64748b' : '#94a3b8' }}>
                          <span>{pkg.aiRecipeLimit === -1 ? t('unlimitedLabel', 'Unlimited') : pkg.aiRecipeLimit} {t('aiRecipesLabel', 'AI recipes')}</span>
                          <span>•</span>
