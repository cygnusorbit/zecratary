...
# Make the modal wider (max-w-3xl instead of max-w-xl) and compact the row elements to fit nicely
old_modal_wrapper = 'max-w-xl w-full p-6 space-y-6 shadow-2xl relative max-h-[90vh] flex flex-col'
new_modal_wrapper = 'max-w-3xl w-full p-6 space-y-6 shadow-2xl relative max-h-[90vh] flex flex-col'

if old_modal_wrapper in code:
    code = code.replace(old_modal_wrapper, new_modal_wrapper)

# Replace the row items layout to be compact and properly wrap/fit inside the modal width
old_modal_jsx = """            <div className="overflow-y-auto flex-1 space-y-6 pr-1">
                      ...
                      {catIngs.map((ing) => (
                        ...
                        >
                          ...
                          <input
                            ...
                            className="w-14 bg-slate-900 border border-slate-800 rounded-xl py-2 px-1 text-xs text-white text-center font-bold outline-none focus:border-[#E05638] shrink-0"
                            placeholder="Qty"
                          />
                          ...
                          <input
                            ...
                            className="w-20 bg-slate-900 border border-slate-800 rounded-xl py-2 px-1 text-xs text-slate-300 text-center outline-none focus:border-[#E05638] shrink-0"
                            placeholder="Unit"
                          />
...
print("✅ Shopping List modal width and row layout successfully fixed!")
