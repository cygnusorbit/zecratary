          ...
          <div className="bg-[#111726] border border-slate-800 rounded-3xl max-w-4xl w-full max-h-[92vh] flex flex-col overflow-hidden shadow-2xl relative">
            ...
            <div className="overflow-y-auto flex-1 space-y-6">
              ...
              {!isEditing ? (
                ...
                /* FULL EDIT FORM WITH MATCHING REFERENCE INGREDIENTS LAYOUT & REORDER BUTTON */
                <div className="p-6 space-y-6">
                  ...
                  {/* INGREDIENTS EDIT TAB MATCHING REFERENCE SCREENSHOT */}
                  {editTab === 'ingredients' && (
                    <div className="space-y-4 text-xs">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="bg-[#1B2436] hover:bg-[#25324A] text-slate-200 font-bold px-3 py-1.5 rounded-lg border border-slate-700 transition"
                          >
                            Reorder
                          </button>
                          <button
                  ...
                  {/* STEPS EDIT TAB WITH REORDER BUTTON */}
                  {editTab === 'steps' && (
                    <div className="space-y-4 text-xs">
                      <div className="flex justify-between items-center">
...
print("✅ Recipe Ingredients layout and Step Reorder button successfully installed!")
