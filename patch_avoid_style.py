...
export default function ChefChatPage() {
  ...
  const handleSend = async (customText?: string) => {
    ...
    const preferenceContext = `[User Preferences: Servings: ${servings} people, Country: ${country}, Diets: ${selectedDiets.join(', ') || 'None'}, Allergies: ${selectedAllergies.join(', ') || 'None'}, Avoid: ${ingredientsToAvoid.join(', ') || 'None'}, Tastes: ${tastes.join(', ') || 'None'}]`;
    ...
    try {
      ...
      setMessages(prev => [...prev, {
        ...
        recipe: {
          ...
          description: `Prepared for ${servings} servings, respecting avoid list: (${ingredientsToAvoid.join(', ') || 'None'}).`,
          servings: servings,
          prepTimeMinutes: 15,
          cookTimeMinutes: 20,
          calories: 420,
          ...
          fatGrams: 12,
          ingredients: [
            { item: "Clean Selected Ingredients", quantity: "300g" },
            { item: "Seasonings", quantity: "To taste" }
          ],
          instructions: [
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-[#111726] border border-slate-800 rounded-3xl max-w-lg w-full max-h-[90vh] flex flex-col overflow-hidden shadow-2xl relative p-6 space-y-6">
            ...
            <div className="overflow-y-auto flex-1 space-y-5 pr-1 text-xs">
              ...
              {/* Ingredients to Avoid - Redesigned to match Taste section style */}
              <div className="space-y-2">
...
print("✅ Ingredients to Avoid field successfully redesigned to match the Taste section style!")
