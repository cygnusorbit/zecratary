...
with open("apps/web/src/app/ClientLayout.tsx", "w", encoding="utf-8") as f:
    f.write(client_layout_code)

print("✅ Layout successfully split into Server Metadata Layout and Client Sidebar Layout!")
