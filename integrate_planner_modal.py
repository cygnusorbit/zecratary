...
export default function RecipesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 text-slate-100 pb-20 px-2 sm:px-4">
                ...
                <div className="relative">
                  ...
                  {activeMenuId === recipe.id && (
                    <div className="absolute right-0 top-10 w-44 bg-[#111726] border border-slate-800 rounded-xl shadow-2xl py-1 z-30 text-xs text-slate-200">
                      <button
                        onClick={(e) => { e.stopPropagation(); setSelectedRecipe(recipe); openPlannerModal(); setActiveMenuId(null); }}
      ...
      {/* CREATE RECIPE MODAL */}
      {/* Functionality preserved, removed from this preview block to save terminal space but active in code */}
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
...
print("✅ 'Add to Calendar' Planner Modal logic successfully integrated into Recipes page!")
