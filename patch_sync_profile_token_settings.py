...
export default function ProfilePage() {
  ...
  // Sync Plans and Token Limits from /admin/plans
  ...
  const reloadActiveUser = useCallback(() => {
    ...
    syncActivePlanTokens(userPlan, plans);
  }, [plans, syncActivePlanTokens]);
  ...
  // Token percentage calculation handling unlimited (-1)
