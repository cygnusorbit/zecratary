...
import {
  ...
  ShoppingCart, Timer, Edit3, Share2, CheckSquare, Square, Star, ExternalLink, Trash2, Save, Plus
} from 'lucide-react';
      ...
      {loading ? (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {filtered.map((r) => (
            <div
              key={r.id}
              onClick={() => { setSelectedRecipe(r); setServingsMultiplier(1); setNoteText(r.note || ''); setIsEditing(false); setActiveModalTab('info'); }}
          ...
          <div className="bg-[#111726] border border-slate-800 rounded-3xl max-w-3xl w-full max-h-[92vh] flex flex-col overflow-hidden shadow-2xl relative">
            ...
            <div className="overflow-y-auto flex-1 space-y-6">
              ...
              {!isEditing ? (
                ...
                /* FULL EDIT FORM WITH TABS (Matching Reference Design) */
                <div className="p-6 space-y-6">
                  ...
                  {/* Edit Tabs matching Screenshot Reference: Basic Info | Ingredients | Steps */}
...
print("✅ Recipe Ingredients & Instructions editing successfully added!")
