...
# -------------------------------------------------------------
# 1. Update Import Page Placeholders
# -------------------------------------------------------------
          ...
          {activeTab === 'url' && (
            <div className="space-y-4">
              ...
              <input
                ...
                className="w-full bg-[#0B101D] border border-slate-800 rounded-xl px-4 py-3 text-sm text-slate-200 placeholder-slate-400 focus:outline-none focus:border-[#E05638]"
              />
              <button
...
# -------------------------------------------------------------
# 2. Update Manual Recipe Page Placeholders
# -------------------------------------------------------------
            ...
            <div className="bg-[#111726] border border-slate-800 rounded-2xl p-6 space-y-4 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0B101D] border border-slate-800 rounded-xl p-3 text-sm text-white placeholder-slate-400 outline-none focus:border-[#E05638]"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#0B101D] border border-slate-800 rounded-xl p-3 text-sm text-white placeholder-slate-400 outline-none focus:border-[#E05638] resize-y"
                />
              </div>
              ...
              {form.ingredients.map((ing, idx) => (
                ...
                >
                  <input
                    ...
                    className="w-16 bg-slate-900 border border-slate-800 rounded-lg p-2 text-center text-white placeholder-slate-400 font-bold outline-none"
                  />
                  <input
                    type="text"
                    placeholder="Unit"
                    ...
                    className="w-20 bg-slate-900 border border-slate-800 rounded-lg p-2 text-center text-slate-300 placeholder-slate-400 outline-none"
                  />
                  <input
                    type="text"
                    ...
                    className="flex-1 bg-transparent border-none text-white placeholder-slate-400 outline-none px-2"
                  />
                  <select
                    value={ing.category}
                    onChange={(e) => {
              ...
              {form.instructions.map((step, idx) => (
                ...
                >
                  ...
                  <textarea
                    ...
                    className="flex-1 bg-transparent border-none text-white placeholder-slate-400 outline-none resize-y"
                  />
...
print("✅ Placeholder text color darkened to slate-400 across import & manual pages!")
