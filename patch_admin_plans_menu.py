...
import { 
  ...
  LayoutTemplate, User, Box, CreditCard 
} from 'lucide-react';
import './globals.css';
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { label: 'Package Plans', href: '/package', icon: Box },
    { label: 'Admin Setting', href: '/admin', icon: ShieldCheck },
    { label: 'Admin Plans', href: '/admin/plans', icon: CreditCard },
...
print("✅ Admin Plans menu successfully added to the sidebar navigation!")
