...
# ----------------------------------------------------------------------
# 1. Update /manual page (apps/web/src/app/manual/page.tsx)
# ----------------------------------------------------------------------
manual_path = "apps/web/src/app/manual/page.tsx"
manual_code = """'use client';
...
# ----------------------------------------------------------------------
# 2. Update /recipes and /recipe pages with Global Categories
# ----------------------------------------------------------------------
recipes_code = """'use client';
import { useState, useEffect } from 'react';
import Link from 'next/link';
import {
...
print("✅ Global category mappings successfully applied to /manual, /recipes, and /recipe!")
