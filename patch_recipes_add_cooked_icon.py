            ...
            return (
              ...
              >
                <div className="relative h-44 w-full bg-slate-800 overflow-hidden">
                  ...
                  {/* TOP-RIGHT ACTIONS: COOKED ICON NEXT TO FAVORITE ICON */}
                ...
                <div className="p-4 space-y-2">
                  ...
                  {/* Card Bottom: Category Tag + Star Rating + Prep/Cook Time */}
...
print("✅ 'Mark as Cooked' icon button successfully added next to the Favorite heart icon on recipe cards!")
